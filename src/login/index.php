...
<body>
    ...
    <div class="card <?= $message_type === 'error' ? 'shake' : ''?>">
        ...
        <form method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <svg class="input-icon" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <button type="button" class="toggle-pw" onclick="togglePassword()" title="ສະແດງ/ເຊື່ອງລະຫັດຜ່ານ"
                        aria-label="Toggle password">
                        <svg id="eye-icon" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
        ...
        <p class="register-link">
            ຍັງບໍ່ມີບັນຊີ?
            <a href="../register/index.php">ສ້າງບັນຊີໃໝ່</a>
        </p>
